...
#Starting Values for Atchade algorithm
Atch_starting_values_slopes <- set_atchade_slope_parameters(slopeBar_start, 0.1, length(slopeBar_start), nrow(slope_start))
Atch_starting_values_lambda <- set_atchade_lambda_parameters(15, 2, c(NA, 20), c(NA, 15))
